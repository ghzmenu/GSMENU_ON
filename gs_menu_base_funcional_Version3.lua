-- ============================================================================
-- GS MENU v3 - VERSÃO COMPLETA COM TODAS AS ANIMAÇÕES
...
-- ============================================================================
-- ESTADO DE MINIMIZAÇÃO E ESTADO DOS TOGGLES
-- ============================================================================

local isMenuMinimized = false
local toggleStates = {} -- Armazenar estado de todos os toggles
...
gapFrame.Size = UDim2.new(0.78, 0, 0, 9)
...
for index, tabName in ipairs(allTabs) do
	...
	tabButton.MouseButton1Click:Connect(function()
		...
		-- Animação do traço roxo deslizando até a nova posição
		local tweenIndicator = TweenService:Create(indicator, TWEEN_INFO, {Position = indicator.Position})
		tweenIndicator:Play()
...
-- ============================================================================
-- CLICK PARA MINIMIZAR/EXPANDIR (HAMBURGER BUTTON)
-- ============================================================================
...
hamburgerButton.MouseButton1Click:Connect(function()
	...
	if isMenuMinimized then
		-- MINIMIZAR - Esconder menu inferior
		local tweenMenu = TweenService:Create(contentMenu, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), 
			{Size = UDim2.new(0.78, 0, 0, 0)})
		tweenMenu:Play()
		
		local tweenGap = TweenService:Create(gapFrame, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
			{Size = UDim2.new(0.78, 0, 0, 0)})
		tweenGap:Play()
		
		hamburgerButton.Text = "▼"
		print("[GS MENU] Menu minimizado! (Funções ativas preservadas)")
	else
		-- EXPANDIR - Mostrar menu inferior
		local tweenMenu = TweenService:Create(contentMenu, TweenInfo.new(0.4, Enum.EasingStyle.Quad, Enum.EasingDirection.Out),
			{Size = UDim2.new(0.78, 0, 0.585, 0)})
		tweenMenu:Play()
...
print("[GS MENU v3] ✓ Minimizar/Expandir funcionando!")
print("[GS MENU v3] ✓ Estado dos toggles preservado!")