...
contentCorner.CornerRadius = UDim.new(0.02, 0)  -- REDUZIDO DE 0.05 PARA 0.02 (2%)
...
local function createTabContent(tabName)
	...
	wrapperCorner.CornerRadius = UDim.new(0.02, 0)  -- REDUZIDO DE 0.02 PARA 0.02 (2%)
	...
	divider.Position = UDim2.new(0.25, 0, 0.05, 0)
...
print("[GS MENU v3] ✓ Borda reduzida para 2%!")
