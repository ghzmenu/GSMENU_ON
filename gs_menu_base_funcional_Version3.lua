...
gapFrame.Size = UDim2.new(0.78, 0, 0, 5)  -- REDUZIDO DE 9 PARA 5
...
contentMenu.Position = UDim2.new(0.11, 0, 0.05, 66)  -- AJUSTADO DE 76 PARA 66
...
dividerLine.Position = UDim2.new(0.26, 0, 0.075, 0)
	...
	if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
		...
		dragState.dragInput = input.Changed:Connect(function()
			if dragState.isDragging then
				...
				contentMenu.Position = dragState.startPos + UDim2.new(0, delta.X, 0, delta.Y + 46)  -- AJUSTADO
				gapFrame.Position = dragState.startPos + UDim2.new(0, delta.X, 0, delta.Y + 36)   -- AJUSTADO
			end
		end)
	end
end)
...
print("[GS MENU v3] ✓ Espaçamento reduzido em 50%!")
