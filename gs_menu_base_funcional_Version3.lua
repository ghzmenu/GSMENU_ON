-- ============================================================================
-- GS MENU v3 - VERSÃO COMPLETA COM ANIMAÇÕES (DRAG CORRIGIDO)
...
-- ============================================================================
-- CRIAR SCREENGUI COM BLOCKINPUT
-- ============================================================================
...
-- ============================================================================
-- SISTEMA DE DRAG MELHORADO (SEM INTERAÇÃO COM FUNDO)
-- ============================================================================
...
headerBar.InputBegan:Connect(function(input, gameProcessed)
	if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
		...
		dragState.headerStartPos = headerBar.Position
		dragState.contentStartPos = contentMenu.Position
		dragState.gapStartPos = gapFrame.Position
		...
		dragState.dragInput = input.Changed:Connect(function()
			if dragState.isDragging then
				...
				-- Atualizar posições de todos os elementos do menu
				local newHeaderPos = dragState.headerStartPos + UDim2.new(0, delta.X, 0, delta.Y)
				local newContentPos = dragState.contentStartPos + UDim2.new(0, delta.X, 0, delta.Y)
				local newGapPos = dragState.gapStartPos + UDim2.new(0, delta.X, 0, delta.Y)
				
				headerBar.Position = newHeaderPos
				contentMenu.Position = newContentPos
				gapFrame.Position = newGapPos
			end
		end)
	end
end)
