...
dividerLine.Position = UDim2.new(0.20, 0, 0.075, 0)  -- MOVIDO PARA O MEIO (0.5)
...
local function createTabContent(tabName)
	...
	contentWrapper.BackgroundTransparency = 1  -- REMOVIDO FUNDO (ERA COLOR_CONTENT_BG)
	...
	divider.Position = UDim2.new(0.45, 0, 0.05, 0)
...
print("[GS MENU v3] ✓ Fundo removido e linha divisória centralizada!")
