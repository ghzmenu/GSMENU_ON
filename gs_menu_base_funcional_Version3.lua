-- ============================================================================
-- GS MENU v3 - VERSÃO COMPLETA COM ANIMAÇÕES (DRAG EM TODO MENU)
...
-- ============================================================================
-- CRIAR FRAME INVISÍVEL PARA DRAG (COBRE TODO O MENU)
-- ============================================================================

local dragFrame = Instance.new("Frame")
dragFrame.Name = "DragFrame"
dragFrame.Size = UDim2.new(0.78, 0, 0.66, 0)
dragFrame.Position = UDim2.new(0.11, 0, 0.05, 20)
...
-- ============================================================================
-- SISTEMA DE DRAG GLOBAL (EM TODO O MENU)
-- ============================================================================

dragFrame.InputBegan:Connect(function(input, gameProcessed)
	if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
		...
		dragState.dragInput = input.Changed:Connect(function()
			if dragState.isDragging then
				...
				-- Atualizar posições de todos os elementos
				local newPos = dragState.startPos + UDim2.new(0, delta.X, 0, delta.Y)
				
				headerBar.Position = newPos
...
print("[GS MENU v3] ✓ Drag global em todo menu - SEM interações no fundo!")
